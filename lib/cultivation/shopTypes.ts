...
export const FRAMES_KEY = 'tien_ky_custom_frames_v1';
export const DHARMA_KEY = 'tien_ky_dharma_idols_v1';
export const ARTIFACTS_KEY = 'tien_ky_custom_artifacts_v1';
export const TITLES_KEY = 'tien_ky_custom_titles_v1';
